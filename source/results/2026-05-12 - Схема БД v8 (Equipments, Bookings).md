# Схема БД v8: Equipments + Bookings (сводный файл)
...
| OQ-DB-3 | Аудит-поля | Закрыт в v8: добавлены во все 21 таблицу (createdAt, createdBy, updatedAt, updatedBy, isDeleted, deletedAt, deletedBy) |
