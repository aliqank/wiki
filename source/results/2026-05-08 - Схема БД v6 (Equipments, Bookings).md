# Схема БД v6: Equipments + Bookings (сводный файл)
...
|---|---|---|
| 1 | Добавлены стандартные аудит-поля во все 19 таблиц — OQ-DB-3 закрыт | Все таблицы |
...
| Тема | Решение |
|---|---|
| Аудит-поля | Единый набор из 7 полей добавлен во все 19 таблиц. Для log/history-таблиц updatedAt/updatedBy ожидаются как NULL. createdBy / updatedBy / deletedBy — UUID без FK-ограничения |
...
| 2а | FleetManagePermissions | Права управления флотом |
...
| OQ-DB-3 | Аудит-поля | Закрыт в v6: добавлены во все 19 таблиц (createdAt, createdBy, updatedAt, updatedBy, isDeleted, deletedAt, deletedBy) |
