...
**Version:** v9 (Equipments + Bookings + simplified reference dictionaries)
...
erDiagram
    ...
    EquipmentBrandModels ||--o{ Equipments              : "brandModelId"
...
Каждая из 30 таблиц содержит стандартный набор:
