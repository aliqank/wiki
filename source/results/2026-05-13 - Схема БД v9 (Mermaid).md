# Схема БД v9 — Mermaid ER-диаграмма

**Created:** 2026-05-13  
**Last updated:** 2026-05-13  
**Version:** v9 (Equipments + Bookings + hierarchical reference dictionaries)
...
erDiagram
    ...
    Equipments {
        ...
        TEXT description
        UUID equipmentBrandId FK
        UUID equipmentModelId FK
        ENUM shareType
        BOOLEAN isCritical
    ...
    EquipmentBrandModels ||--o{ EquipmentBrandModels    : "parentId (self-ref)"
    EquipmentBrandModels ||--o{ Equipments              : "equipmentBrandId"
    EquipmentBrandModels ||--o{ Equipments              : "equipmentModelId"
    Locations            ||--o{ Equipments              : "baseLocationId"
    CostCenters          ||--o{ Equipments              : "costCenterId"
    ServiceZones         ||--o{ Equipments              : "serviceZoneId"
    OrganizationalUnits  ||--o{ OrganizationalUnits     : "parentId (self-ref)"
    OrganizationalUnits  ||--o{ Equipments              : "organizationalUnitId"
...
Каждая из 26 таблиц содержит стандартный набор:
