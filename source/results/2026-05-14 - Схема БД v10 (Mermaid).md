...
erDiagram
    ...
    JdeWorkOrders {
        UUID id PK
        VARCHAR jdeWorkOrderId
        VARCHAR workOrderName
        VARCHAR workOrderStatus
        VARCHAR workOrderStatusDescription
        ENUM priority
        JSONB sourcePayload
...
Каждая из 34 таблиц содержит стандартный набор:
