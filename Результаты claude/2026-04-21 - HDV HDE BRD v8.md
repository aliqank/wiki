...
# Business Requirement Document — v8

**Version:** 8.0  
**Date:** 2026-04-22
**Based on:** BRD v7 (2026-04-20) + Requirements gathered in meeting 20.04.2026  
...
| # | Section | Change |
|---|---------|--------|
| 1 | 3. Glossary / OQ-NEW-K | OQ-NEW-K CLOSED: historical route on GIS map — 7 days, confirmed 20.04 |
| 2 | 5.1 Equipment | BP equipment field requirements clarified: unified database confirmed; mandatory vs. optional fields per ownership type |
| 3 | 6.4 Request Management | FR-NEW-64 added: FO approval window — equipment loading summary by dates (booking list under given unit) |
| 4 | 6.12 Dashboards / Map | FR-NEW-62 updated: GIS tooltip content = all available sensor data from last sync |
| 5 | 6.12 Dashboards / Map | FR-NEW-63 added: utilization dashboard — booking count for selected period displayed next to average |
| 6 | 6.12 Dashboards / Map | FR-NEW-65 added: GIS map — speed and direction display rules (GSM vs. LoRaWAN) |
| 7 | 6.12 Dashboards / Map | FR-NEW-66 added: GIS map — fuel level not displayed (telemetry data unavailable) |
| 8 | 6.12 Dashboards / Map | FR-NEW-67 added: GIS map — historical route for 7 days |
| 9 | 10. Open Questions | OQ-NEW-K closed; new OQs from 20.04 added; full details in separate document "Open Questions v1" |
| 10 | 11. New Requirements | FR-NEW-63–FR-NEW-67 added to summary |
...
| Area | Original BRD | Current Version (v8) |
|------|-------------|----------------------|
...
Status: Under clarification whether a consistent 30‑minute refresh can be guaranteed
