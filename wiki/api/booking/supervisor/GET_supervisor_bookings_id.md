...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-NEW-73 | Supervisor reviews booking including [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) justification | Confirmed | BRD v13 | Карточка решения |
...
|---|---|
| [`FleetOwnersSupervisor`](../../../requirements/Roles%20and%20Access%20Model.md) | Просмотр карточек long-term rented броней на финальном шаге |
