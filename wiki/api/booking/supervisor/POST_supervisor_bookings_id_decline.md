...
| 1.3 | Комментарий Supervisor | supervisorComment | string | string | — | Bookings.supervisorComment |  |
| 1.4 | Дата и время решения Supervisor | supervisorApprovedAt | datetime | ISO 8601 | — | Bookings.supervisorApprovedAt |  |
