...
| TCO Booking Tool | FR-079 | System notifies [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md)/SWP of FO decision | Confirmed | BRD v13 | Timeline должен отражать approval decisions |
| TCO Booking Tool | FR-NEW-75 | System notifies [`FleetOwners' Supervisor`](../../../requirements/Roles%20and%20Access%20Model.md) when Long-term rented booking reaches Confirmed by FO | Confirmed | BRD v13 | Timeline должен показывать multi-step approval chain |
| TCO Booking Tool | FR-NEW-76 | System notifies Requestor and FO when [`FleetOwners' Supervisor`](../../../requirements/Roles%20and%20Access%20Model.md) makes a decision | Confirmed | BRD v13 | Timeline должен показывать supervisor decision event |
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Timeline собственной брони |
| [`ServiceWorkProcessor`](../../../requirements/Roles%20and%20Access%20Model.md) | Timeline броней по доступным Service Work Request |
| [`FleetOwner`](../../../requirements/Roles%20and%20Access%20Model.md) | Timeline броней своих флотов |
| [`FleetOwnersSupervisor`](../../../requirements/Roles%20and%20Access%20Model.md) | Timeline long-term rented броней |
