...
| № | Описание поля | Наименование поля модели | Тип параметра (backend) | Формат | Значение по умолчанию | Источник данных | Комментарий |
|---|---|---|---|---|---|---|---|
| 1 | Тип события | eventType | string | string | — | backend timeline aggregation |  |
| 2 | Текущий статус | status | string | string | — | backend timeline aggregation from BookingStatuses |  |
| 3 | Дата и время события | occurredAt | datetime | ISO 8601 | — | backend timeline aggregation |  |
