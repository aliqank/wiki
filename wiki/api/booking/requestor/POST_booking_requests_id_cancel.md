...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-025 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can view request details and status | Confirmed | BRD v13 | Метод меняет доступное requestor состояние и отражается в request details/list view |
| TCO Booking Tool | FR-027 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can edit/cancel draft before submission | Confirmed | BRD v13 | Прямое покрытие |
...
1. Проверить существование заявки и права доступа.
   Для роли [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) доступ определяется по `BookingRequests.requestorId = currentUserId`, а не по audit-полю `createdBy`.
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Отмена draft-заявки, где пользователь является `requestorId` |
