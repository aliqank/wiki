...
2. Проверить доступ: Requestor видит только заявки, где `BookingRequests.requestorId = currentUserId`; SWP видит доступные ему рабочие заявки по правилам SWR visibility.
