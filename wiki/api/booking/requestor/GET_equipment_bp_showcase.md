...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-NEW-25 | On-demand BP (Showcase): [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can view on-demand BP equipment; no booking action in Phase 1 | Confirmed | BRD v13 | Прямое покрытие showcase browse flow |
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Просмотр BP showcase техники в read-only режиме |
