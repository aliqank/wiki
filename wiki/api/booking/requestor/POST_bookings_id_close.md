...
| TCO Booking Tool | FR-NEW-33 | At close: [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) inputs actual start/end time | Confirmed | BRD v13 | Заполняются `actualStartDateTime`, `actualEndDateTime` |
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Закрытие собственной брони |
