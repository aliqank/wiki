...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-022 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can submit feedback on equipment with confirmed booking | Confirmed | BRD v13 | Прямое покрытие для текущего scope |
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Оставление отзыва по своей брони |
