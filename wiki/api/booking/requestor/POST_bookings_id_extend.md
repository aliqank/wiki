...
Новый метод. Обрабатывает запрос [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) на изменение `plannedEndDateTime` с разным поведением для pre-start и `InProgress` сценариев.
...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-061 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can extend confirmed booking | Confirmed | BRD v13 | Базовое покрытие change-end-date сценария для текущего scope |
...
| TCO Booking Tool | FR-081 | System notifies FO when [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) extends booking | Confirmed | BRD v13 | Уведомление FO обязательно |
...
7. Уведомить [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) о запросе на изменение срока брони.
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Изменение `plannedEndDateTime` собственной брони |
