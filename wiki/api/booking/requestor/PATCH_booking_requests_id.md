...
| 1.4 | Приоритет | priority | string | string | — | response DTO |  |
| 1.5 | Комментарии | comments | string | string | — | response DTO |  |
...
| 4 | Приоритет | priority | string | string | — | response DTO |  |
| 5 | Комментарии | comments | string | string | — | response DTO |  |
