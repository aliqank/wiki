...
| TCO Booking Tool | FR-NEW-11 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) selects priority P1-P4 | Confirmed | BRD v13 | Метод сохраняет `priority` в draft-заявке |
...
|---|---|
| [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) | Редактирование draft-заявки, где пользователь является `requestorId` |
