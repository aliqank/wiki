...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-031 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can add/remove equipment items to a request | Confirmed | BRD v13 | Тип владения участвует в фильтрации техники |
...
2. Исключить значения, которые не участвуют в поиске [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md), например `OnDemand`.
