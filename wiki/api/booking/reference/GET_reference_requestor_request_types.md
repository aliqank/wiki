...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-091 | Requestor can search and filter own requests | Confirmed | BRD v13 | Значения фильтра `type` должны загружаться отдельным reference API для текущего scope |
