...
| Параметр | Значение |
|---|---|
| Описание | Получить справочник статусов заявки для фильтра [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) view `Approvals -> Requests` |
...
Новый reference API для `UC-FO-03`. Используется для загрузки списка значений фильтра `status` во view [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) `Approvals -> Requests`.
...
3. Не возвращать `Draft` и `Closed`, так как они не должны использоваться во [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) request list.
...
|---|---|
| [`FleetOwner`](../../../requirements/Roles%20and%20Access%20Model.md) | Просмотр и фильтрация заявок в approval request view |
