...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-025 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can view request details and status | Confirmed | BRD v13 | Список заявок должен использовать согласованные request statuses |
| TCO Booking Tool | FR-091 | [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) can search and filter own requests | Confirmed | BRD v13 | Значения фильтра `status` должны загружаться отдельным reference API для текущего scope |
