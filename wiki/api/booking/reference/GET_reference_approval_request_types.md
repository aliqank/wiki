...
| Параметр | Значение |
|---|---|
| Описание | Получить справочник типов заявки для фильтра [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) view `Approvals -> Requests` |
...
Новый reference API для `UC-FO-03`. Используется для загрузки списка значений фильтра `type` во view [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) `Approvals -> Requests`.
