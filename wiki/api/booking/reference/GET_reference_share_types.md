...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-031 | [`Requestor`](../../../requirements/Roles and Access Model.md) can add/remove equipment items to a request | Confirmed | BRD v13 | Тип доступности участвует в фильтрации техники |
