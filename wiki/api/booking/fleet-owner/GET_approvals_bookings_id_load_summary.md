...
| Параметр | Значение |
|---|---|
| Описание | Получить сводку загрузки техники на даты брони для [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) |
...
|---|---|
| [`FleetOwner`](../../../requirements/Roles%20and%20Access%20Model.md) | Просмотр загрузки техники по своим броням |
...
1. Summary предназначен для принятия решения [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) по competing bookings и не является самостоятельным hard-stop механизмом.
