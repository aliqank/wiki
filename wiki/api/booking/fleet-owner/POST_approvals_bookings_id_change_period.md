...
| 1.2 | Дата и время начала | startDt | datetime | ISO 8601 | — | backend composition from Bookings + BookingStatuses |  |
| 1.3 | Дата и время окончания | endDt | datetime | ISO 8601 | — | backend composition from Bookings + BookingStatuses |  |
| 1.4 | Текущий статус | status | string | string | — | Bookings + BookingStatuses |  |
