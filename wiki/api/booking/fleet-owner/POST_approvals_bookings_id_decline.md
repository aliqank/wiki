...
| Параметр | Значение |
|---|---|
| Описание | Отклонить бронь как [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) |
...
|---|---|
| [`FleetOwner`](../../../requirements/Roles%20and%20Access%20Model.md) | Отклонение броней своих флотов |
