...
| Параметр | Значение |
|---|---|
| Описание | Закрыть бронь вручную как [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) и зафиксировать фактическое время использования |
...
Новый метод. Реализует manual close брони на стороне [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md).
...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-NEW-32 | Booking closure is manual only — "Close" button by Requestor or FO | Confirmed | BRD v13 | Прямое покрытие для [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md) сценария |
| TCO Booking Tool | FR-NEW-33 | At close: [`Requestor`](../../../requirements/Roles%20and%20Access%20Model.md) inputs actual start/end time for usage rate analytics | Confirmed | BRD v13 | Для FO close используются те же фактические даты в аналитических целях |
...
2. Разрешить close только для активной подтвержденной / in-progress брони в зоне ответственности текущего [`Fleet Owner`](../../../requirements/Roles%20and%20Access%20Model.md).
...
|---|---|
| [`FleetOwner`](../../../requirements/Roles%20and%20Access%20Model.md) | Закрытие броней своих флотов |
