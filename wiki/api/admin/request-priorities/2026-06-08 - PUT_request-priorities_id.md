...
| Параметр | Значение |
|---|---|
| Описание | Сохранить изменения описания и цвета приоритета заявки в справочнике [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel |
...
Новый метод. Используется для редактирования только `description` и `color` существующих priority values `P1`-`P4` в [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel.
