...
| Параметр | Значение |
|---|---|
| Описание | Создать новый тип техники в справочнике [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel |
...
Новый метод. Обеспечивает создание типа техники через форму AP-02 в [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel. Тип техники является корневой справочной сущностью: к нему привязываются динамические характеристики (EquipmentTypeProperties) и единицы техники (Equipments). Метод поддерживает передачу стартового списка характеристик типа в одном запросе.
