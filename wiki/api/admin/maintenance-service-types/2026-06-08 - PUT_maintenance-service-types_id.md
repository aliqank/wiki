...
| Параметр | Значение |
|---|---|
| Описание | Сохранить изменения вида сервисного обслуживания в справочнике [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel |
...
Новый метод. Обрабатывает редактирование строки maintenance service type в справочнике [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel.
