...
| Параметр | Значение |
|---|---|
| Описание | Сохранить изменения вида сервисного обслуживания в справочнике Admin Panel |
...
Новый метод. Обрабатывает редактирование строки maintenance service type в справочнике Admin Panel.
