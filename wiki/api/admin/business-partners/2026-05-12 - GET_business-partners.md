...
| Параметр | Значение |
|---|---|
| Описание | Получить постраничный список бизнес-партнёров для справочника [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel |
...
Новый метод. Используется для экрана управления справочником бизнес-партнёров в [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) Panel. Возвращает список записей с данными, достаточными для отображения и guard-логики удаления.
...
|---|---|---|---|---|---|
| TCO Booking Tool | FR-014 | [`Admin`](../../../requirements/Roles%20and%20Access%20Model.md) редактирует параметры техники и связанные справочные сущности | Confirmed | BRD v13 | Метод нужен для управления справочником бизнес-партнёров |
...
| 1.1 | Элементы текущей страницы | items | array<object> | object[] | — | backend composition from BusinessPartners + Users | Коллекция объектов |
...
| № | Описание поля | Наименование поля модели | Тип параметра (backend) | Формат | Значение по умолчанию | Источник данных | Комментарий |
|---|---|---|---|---|---|---|---|
| 1 | Элементы текущей страницы | items | array<object> | object[] | — | backend composition from BusinessPartners + Users | Коллекция объектов |
