...
| FR-022 | Requestor / SWP can submit feedback on equipment with confirmed booking | CRUD feedback-сущности | `EquipmentFeedbacks` | Хранение фидбэка по booking и equipment покрыто явно |
