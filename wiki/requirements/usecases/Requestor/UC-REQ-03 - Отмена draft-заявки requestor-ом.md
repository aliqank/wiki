...
8. Backend переводит заявку в terminal status `Cancelled`, а связанные draft booking item-ы удаляет либо закрывает с terminal причиной `Cancelled`, после чего фиксирует изменения в истории.
