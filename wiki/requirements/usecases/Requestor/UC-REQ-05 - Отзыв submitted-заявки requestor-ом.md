...
| Предусловие | Пользователь авторизован; у пользователя есть собственная заявка в статусе `Submitted`; ни один booking item этой заявки еще не был подтвержден [`Fleet Owner`](../../Roles%20and%20Access%20Model.md) |
...
3. Для submitted-заявки frontend показывает действие `Отозвать заявку`, только если ни один booking item этой заявки еще не был подтвержден [`Fleet Owner`](../../Roles%20and%20Access%20Model.md).
...
2. Хотя бы один booking item уже подтвержден [`Fleet Owner`](../../Roles%20and%20Access%20Model.md).
