...
1. При замене техники новая единица имеет конфликты с другими активными бронями на выбранный период.
   Backend сохраняет обновление item. Наличие [booking conflict context](../../../../glossary/Glossary.md#booking-conflict-context) не блокирует редактирование и должно быть отражено в UI как информационный признак для последующего решения Fleet Owner.
