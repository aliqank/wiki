...
- `UC-REQ-02.1 - Создание пустого draft заявки.md`
- `UC-REQ-02.2 - Заполнение и редактирование шапки заявки.md`
- `UC-REQ-02.3 - Поиск техники для добавления в заявку.md`
- `UC-REQ-02.4 - Добавление техники в draft-заявку.md`
- `UC-REQ-02.5 - Редактирование брони или замена техники в draft.md`
- `UC-REQ-02.6 - Отправка draft-заявки.md`
