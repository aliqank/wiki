...
| `UC-FO-05` | Закрытие брони Fleet Owner | Страница `Approvals` → detail / action view активной брони | `BRD: FR-NEW-32, FR-NEW-33; Additional: BRD-U-001` | `GET /approvals/bookings/{id}`, `POST /approvals/bookings/{id}/close` |
